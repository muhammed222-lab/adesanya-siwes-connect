...
const RegisterForm = () => {
  ...
  const validRole = ["student", "supervisor", "coordinator"].includes(
    role || ""
  )
    ? (role as UserRole)
    : "student";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Matriculation Number field removed because students are redirected to their dedicated signup page */}
